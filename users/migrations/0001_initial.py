# Generated by Django 3.1.6 on 2021-04-02 19:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantité', models.CharField(default='', max_length=1000)),
                ('date_posted', models.DateTimeField(default=django.utils.timezone.now)),
                ('principal_image', models.FileField(blank=True, upload_to='')),
                ('name_business', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.page')),
                ('userr', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prod', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='users.prod')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
